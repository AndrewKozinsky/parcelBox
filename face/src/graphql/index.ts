...
export type GetAddressSuggestionsInput = {
  /** Address */
...
export type Query = {
  ...
  helper_addressSuggestions: Array<Scalars['String']['output']>;
...
export type QueryHelper_AddressSuggestionsArgs = {
...
export type ParcelBoxCreate = { __typename?: 'Mutation', parcelBox_create: { __typename?: 'ParcelBoxOutModel', id: number, parcelBoxTypeId: number, parcelBoxTypeName: string, createdAt: any, cells: Array<{ __typename?: 'CellOutModel', id: number, name: string, cellTypeId: number, parcelBoxId: number, width: number, height: number, depth: number }>, location: { __typename?: 'LocationOutModel', id: number, address: string | null, businessDays: Array<number> | null, businessTimeFrom: string | null, businessTimeTo: string | null } } };
...
export type HelperAddressSuggestionsVariables = Exact<{
  input: GetAddressSuggestionsInput;
}>;


export type HelperAddressSuggestions = { __typename?: 'Query', helper_addressSuggestions: Array<string> };
...
export const HelperAddressSuggestionsDocument = gql`
    query HelperAddressSuggestions($input: GetAddressSuggestionsInput!) {
  helper_addressSuggestions(input: $input)
}
    `;

/**
 * __useHelperAddressSuggestions__
 *
 * To run a query within a React component, call `useHelperAddressSuggestions` and pass it any options that fit your needs.
 * When your component renders, `useHelperAddressSuggestions` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useHelperAddressSuggestions({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useHelperAddressSuggestions(baseOptions: Apollo.QueryHookOptions<HelperAddressSuggestions, HelperAddressSuggestionsVariables> & ({ variables: HelperAddressSuggestionsVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<HelperAddressSuggestions, HelperAddressSuggestionsVariables>(HelperAddressSuggestionsDocument, options);
      }
export function useHelperAddressSuggestionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<HelperAddressSuggestions, HelperAddressSuggestionsVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<HelperAddressSuggestions, HelperAddressSuggestionsVariables>(HelperAddressSuggestionsDocument, options);
        }
export function useHelperAddressSuggestionsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<HelperAddressSuggestions, HelperAddressSuggestionsVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<HelperAddressSuggestions, HelperAddressSuggestionsVariables>(HelperAddressSuggestionsDocument, options);
        }
export type HelperAddressSuggestionsHookResult = ReturnType<typeof useHelperAddressSuggestions>;
export type HelperAddressSuggestionsLazyQueryHookResult = ReturnType<typeof useHelperAddressSuggestionsLazyQuery>;
export type HelperAddressSuggestionsSuspenseQueryHookResult = ReturnType<typeof useHelperAddressSuggestionsSuspenseQuery>;
export type HelperAddressSuggestionsQueryResult = Apollo.QueryResult<HelperAddressSuggestions, HelperAddressSuggestionsVariables>;