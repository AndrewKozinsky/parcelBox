 ...
 * });
 */
export function useHelperAddressSuggestions(
	baseOptions: Apollo.QueryHookOptions<HelperAddressSuggestions, HelperAddressSuggestionsVariables> &
		({ variables: HelperAddressSuggestionsVariables; skip?: boolean } | { skip: boolean }),
) {
	const options = { ...defaultOptions, ...baseOptions }
	return Apollo.useQuery<HelperAddressSuggestions, HelperAddressSuggestionsVariables>(
		HelperAddressSuggestionsDocument,
		options,
	)
}
export function useHelperAddressSuggestionsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<HelperAddressSuggestions, HelperAddressSuggestionsVariables>,
) {
	const options = { ...defaultOptions, ...baseOptions }
	return Apollo.useLazyQuery<HelperAddressSuggestions, HelperAddressSuggestionsVariables>(
		HelperAddressSuggestionsDocument,
		options,
	)
}
export function useHelperAddressSuggestionsSuspenseQuery(
	baseOptions?:
		| Apollo.SkipToken
		| Apollo.SuspenseQueryHookOptions<HelperAddressSuggestions, HelperAddressSuggestionsVariables>,
) {
	const options = baseOptions === Apollo.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions }
	return Apollo.useSuspenseQuery<HelperAddressSuggestions, HelperAddressSuggestionsVariables>(
		HelperAddressSuggestionsDocument,
		options,
	)
}
...
export type HelperAddressSuggestionsSuspenseQueryHookResult = ReturnType<
	typeof useHelperAddressSuggestionsSuspenseQuery
>
export type HelperAddressSuggestionsQueryResult = Apollo.QueryResult<
	HelperAddressSuggestions,
	HelperAddressSuggestionsVariables
>
